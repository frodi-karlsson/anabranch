...
| [queue-redis](./packages/queue-redis)                 | Redis adapter for @anabranch/queue using ioredis. Supports all queue features with Redis streams for persistent messaging.                  | [![bundle](https://deno.bundlejs.com/?q=@anabranch/queue-redis&badge=minified&badge-style=flat)](https://bundlejs.com/?q=%40anabranch%2Fqueue-redis)                 |
| [queue-rabbitmq](./packages/queue-rabbitmq)           | RabbitMQ adapter for @anabranch/queue using amqplib. Supports all queue features with RabbitMQ queues for persistent messaging.             | [![bundle](https://deno.bundlejs.com/?q=@anabranch/queue-rabbitmq&badge=minified&badge-style=flat)](https://bundlejs.com/?q=%40anabranch%2Fqueue-rabbitmq)           |
